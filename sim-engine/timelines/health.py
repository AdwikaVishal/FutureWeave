...
class HealthTimelineGenerator(TimelineGenerator):
    def node_names(self) -> list[str]:
        return [
            "treatment_success", "quality_of_life", "recovery_progress",
            "risk_level", "stress", "health",
            "relationships", "happiness", "opportunity",
        ]
